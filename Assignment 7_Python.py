...
8. The | character signifies matching "either, or" between two grou
...
14. .*? is non-greedy. * will match nothing, but then will try to match extra characters until it matches 1, eventually matching 101.
...
21. re.compile(r'[A-Z][a-z]*\hWatanabe')
